...
<@page.pageBase currentMenu="商品管理">
    ...
    <script>
        $(function () {
            ...
            KindEditor.ready(function (K) {
                var editorProduct = K.create('textarea[name="productHTML"]', {
                    allowFileManager: true,
                    uploadJson: '${basepath}/editor/upload',
                    fileManagerJson: '${basepath}/editor/fileManager'
                });

                var editorFileManager = K.editor({
                    fileManagerJson: '${basepath}/editor/fileManager'
                });
                K('input[name=filemanager]').click(function () {
                    var imagesInputObj = $(this).parent().children("input[ccc=imagesInput]");
                    editorFileManager.loadPlugin('filemanager', function () {
                        editorFileManager.plugin.filemanagerDialog({
                            viewType: 'VIEW',
                            dirName: 'image',
                ...
                //添加副图
                K('#addImage').click(function () {
                    editorProduct.loadPlugin('image', function () {
                        editorProduct.plugin.imageDialog({
                            ...
                            clickFn: function (url) {
                                ...
                                var tableObj = document.getElementById("newImagesTable");
    ...
    <form id="form" action="${basepath}/manage/product/">
        ...
        <div style="text-align: center;">
            ...
            <#if e.id??>
                ...
                <#if e.status??&&e.status!=2>
                    <button method="updateUpProduct" class="btn btn-warning"
                            onclick="return confirm('确定上架商品吗?');">
                        <i class="icon-arrow-up icon-white"></i> 上架
                    </button>
                <#else>
                    <button method="updateDownProduct" class="btn btn-warning"
                            onclick="return confirm('确定下架商品吗?');">
                ...
                <a target="_blank" href="${basepath}/freemarker/create?method=staticProductByID&id=${e.id!""}"
        ...
        <div id="tabs">
            ...
            <div id="tabs-1">
                ...
                <div class="row form-horizontal" -role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input type="text" value="${e.name!""}" name="name"
                                   data-rule="商品名称;required;name;length[0~44];" size="44" maxlength="44"
                                   style="width: 80%;"
                                   id="name"/>
                        </div>
                    </div>
                        ...
                        <div class="col-md-8">
                            <select onchange="catalogChange(this)" name="catalogID" id="catalogSelect">
                                ...
                                <#list catalogs as item>
                                    <option pid="0" value="${item.id!""}"><font color='red'>${item.name!""}</font>
                                    </option>
                                    <#if item.children??>
                        ...
                        <div class="col-md-8">
                            ...
                            <select id="unit" name="unit" class="input-medium">
                                <#list map?keys as key>
                                    <option value="${key}"
                                            <#if e.unit?? && e.unit==key>selected="selected" </#if>>${map[key]}</option>
                                </#list>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input type="text" id="picPath" name="picture" value="${e.picture!""}" required="true"
                                   readonly="readonly"/>
                            <button id="pic" class="btn" value="上传图片"></button>
                            <#if e.picture?? && e.picture != "">
                                <a target="_blank" href="${systemSetting().imageRootPath}${e.picture!""}">
                                    <img style="max-width: 50px;max-height: 50px;" alt=""
                                         src="${systemSetting().imageRootPath}${e.picture!""}">
                                </a>
                            </#if>
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                        ...
                        <div class="col-md-8"><input type="text" value="${e.price!""}" name="price"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="col-md-8"><input type="text" value="${e.nowPrice!""}" name="nowPrice"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="col-md-8"><input type="text" value="${e.stock!""}" name="stock"
                                                     data-rule="库存;required;integer;stock;"
                                                     id="stock"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="col-md-8"><input type="text" value="${e.sellcount!""}" name="sellcount"
                                                     data-rule="销量;required;integer;sellcount;"
                                                     id="sellcount"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="col-md-8">
                            ...
                            <select id="sale" name="sale" class="input-medium">
                                <#list map?keys as key>
                                    <option value="${key}"
                                            <#if e.sale?? && e.sale==key>selected="selected" </#if>>${map[key]}</option>
                                </#list>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input type="text" value="${e.score!""}" name="score" type="text" id="score" maxlength="20"
                                   data-rule="销量;required;integer;score;"/>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input type="text" value="${e.description!""}" name="description" type="text"
                                   class="form-control"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input type="text" value="${e.keywords!""}" name="keywords" type="text"
                                   class="form-control"/>
                        </div>
                    </div>
                    <#if e.id??>
            ...
            <div id="tabs-2">
                <textarea data-rule="商品介绍;required;productHTML;" id="productHTML" name="productHTML"
            ...
            <div id="tabs-3">
                ...
                <br>
                <table id="newImagesTable" class="table table-bordered">
                    <tr style="background-color: #dff0d8">
                        <td>新增图片</td>
                    </tr>
                    <tr>
                        <td>
                            <button id="addImage" class="btn btn-warning" type="button">添加</button>
                        </td>
                    </tr>
                    <tr style="display:none">
                        <td>
                            <input id="newImages" type="text" ccc="imagesInput" name="images" style="width: 260px;"
                                   readonly="readonly"/>
                        </td>
                    </tr>
                </table>
                ...
                <table class="table">
                    <#if e.parameterList?? && e.parameterList?size gt 0 >
                        <#list e.parameterList as param>
                            <tr>
                                <!-- 隐藏字段 -->
                                <th style="display: none;"><input type="hidden" value="${param.id!""}"
                                                                  name="parameterIds"/></th>
                ...
                <div class="row">
                    <table class="table">
                            ...
                            <#list e.specList as item>
                                <tr>
                                    <td style="display: none;"><input type="hidden" value="${item.id!""}"
                                                                      name="specList[${item_index}].id"/></td>
                                    <td><input type="text" value="${e.specList[item_index].specSize!""}"
                                               name="specList[${item_index}].specSize"
                                               class="search-query input-small"/></td>
                                    <td><input type="text" value="${e.specList[item_index].specColor!""}"
                                               name="specList[${item_index}].specColor"
                                               class="search-query input-small"/></td>
                                    <td><input type="text" value="${e.specList[item_index].specStock!""}"
                                               name="specList[${item_index}].specStock"
                                               class="search-query input-small"/></td>
                                    <td><input type="text" value="${e.specList[item_index].specPrice!""}"
                                               name="specList[${item_index}].specPrice"
                                               class="search-query input-small"/></td>
                                    <td>
                        ...
                        <#else>
                            <#list [1,2] as item>
                                <tr>
                                    <td style="display: none;"><input type="hidden" value="${e.id!""}"
                                                                      name="specList[${item_index}].id"/></td>
                ...
                <select name="giftID">
                    ...
                    <#if giftList??>
                        <#list giftList as item>
                            <option value="${item.id}"
                                    <#if e.giftID?? && e.giftID == item.id>selected="selected"</#if>>${item.giftName!""}</option>
                        </#list>
                    </#if>
                </select>
            </div>
